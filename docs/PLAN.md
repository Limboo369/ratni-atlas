...
| 4 | Cijeli svijet: karta, doba, dijelovi svijeta, učitavanje sa servera | u toku: svijet danas igriv (168 država, 7 regija, online); 1914. na svijetu (60 država, carstva s kolonijama); slijede ostala historijska doba svijeta (tabele u `build/eras_world/`) i balans svijeta |
